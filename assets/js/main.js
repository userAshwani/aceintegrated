(function($){
    ...
    $(".home-slides").on("translate.owl.carousel", function(){
        $(".main-banner-content h1").removeClass("animate__animated animate__fadeInDown").css("opacity", "0");
        $(".main-banner-content p").removeClass("animate__animated animate__zoomIn").css("opacity", "0");
        $(".main-banner-content .btn-box").removeClass("animate__animated animate__fadeInUp").css("opacity", "0");
    });
    $(".home-slides").on("translated.owl.carousel", function(){
        $(".main-banner-content h1").addClass("animate__animated animate__fadeInDown").css("opacity", "1");
        $(".main-banner-content p").addClass("animate__animated animate__zoomIn").css("opacity", "1");
    ...
    $(document).ready(function() {
        $('.odometer').appear(function() {
            ...
            // Set odometer options with slower animation
            window.odometerOptions = {
                duration: 7000 // Slower counter (7 seconds)
            };
    
            odo.each(function() {
                var countNumber = $(this).attr("data-count");
                
                // Start the odometer animation with a slight delay
                if (countNumber) {
...
window.addEventListener('load', function () {
    // Set a timeout to display the modal after 5 seconds
    setTimeout(function () {
